...
module.exports = async () => {
  chain = await protobuf.load(`${__dirname}/../../../contracts/cChannel-eth/lib/data/proto/chain.proto`);
  entity = await protobuf.load(`${__dirname}/../../../contracts/cChannel-eth/lib/data/proto/entity.proto`);
