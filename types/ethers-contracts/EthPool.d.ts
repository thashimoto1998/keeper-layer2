...
interface EthPoolInterface extends Interface {
  functions: {
...
export class EthPool extends Contract {
  connect(signerOrProvider: Signer | Provider | string): EthPool;
  attach(addressOrName: string): EthPool;
  deployed(): Promise<EthPool>;

  on(event: EventFilter | string, listener: Listener): EthPool;
  once(event: EventFilter | string, listener: Listener): EthPool;
  addListener(eventName: EventFilter | string, listener: Listener): EthPool;
  removeAllListeners(eventName: EventFilter | string): EthPool;
  removeListener(eventName: any, listener: Listener): EthPool;
