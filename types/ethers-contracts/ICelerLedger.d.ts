...
interface ICelerLedgerInterface extends Interface {
  functions: {
    openChannel: TypedFunctionDescription<{
      encode([_openChannelRequest]: [Arrayish]): string;
    }>;
...
export class ICelerLedger extends Contract {
  connect(signerOrProvider: Signer | Provider | string): ICelerLedger;
  attach(addressOrName: string): ICelerLedger;
  deployed(): Promise<ICelerLedger>;

  on(event: EventFilter | string, listener: Listener): ICelerLedger;
  once(event: EventFilter | string, listener: Listener): ICelerLedger;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): ICelerLedger;
  removeAllListeners(eventName: EventFilter | string): ICelerLedger;
  removeListener(eventName: any, listener: Listener): ICelerLedger;

  interface: ICelerLedgerInterface;

  functions: {
    openChannel(
      _openChannelRequest: Arrayish,
  ...
  estimate: {
    openChannel(_openChannelRequest: Arrayish): Promise<BigNumber>;
