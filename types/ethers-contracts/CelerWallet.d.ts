...
interface CelerWalletInterface extends Interface {
  functions: {
    ...
    walletNum: TypedFunctionDescription<{ encode([]: []): string }>;
...
export class CelerWallet extends Contract {
  connect(signerOrProvider: Signer | Provider | string): CelerWallet;
  attach(addressOrName: string): CelerWallet;
  deployed(): Promise<CelerWallet>;

  on(event: EventFilter | string, listener: Listener): CelerWallet;
  once(event: EventFilter | string, listener: Listener): CelerWallet;
  addListener(eventName: EventFilter | string, listener: Listener): CelerWallet;
  removeAllListeners(eventName: EventFilter | string): CelerWallet;
  removeListener(eventName: any, listener: Listener): CelerWallet;
